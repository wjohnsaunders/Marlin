...
#define STRING_CONFIG_H_AUTHOR "(Ender3, CR-10S)" // Who made the changes.
 ...
 *    (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER -45.0f  // X offset: -left  +right  [of the nozzle]
#define Y_PROBE_OFFSET_FROM_EXTRUDER -6.0f  // Y offset: -front +behind [the nozzle]
#define Z_PROBE_OFFSET_FROM_EXTRUDER -3.14f // Z offset: -below +above  [the nozzle]
